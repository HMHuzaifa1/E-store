...
function Item(props) {
  return (
    <Col
      ...
      lg="3"
      xl="3"
      className="grid-row-6 sm:grid-row-4 border-1 border-dark rounded-2xl mt-5 bg-slate-900 py-10 opecity-85 hover:pt-2  hover:scale-110 ease-in duration-300 hover:opacity-100"
    >
      <Link to={props.link}>
